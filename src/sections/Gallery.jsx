...
const galleryImages = [
  { id: 1, url: '/images/about/hero_cinematic.png', category: 'Atmosphere' },
  { id: 2, url: '/images/momo.png', category: 'Culinary' },
  { id: 3, url: '/images/about/private_dining.png', category: 'Atmosphere' },
  { id: 4, url: '/images/sekuwa.png', category: 'Culinary' },
  { id: 5, url: '/images/about/chef_portrait.png', category: 'People' },
  { id: 6, url: '/images/thali.png', category: 'Culinary' },
  { id: 7, url: '/images/about/kitchen_prep.png', category: 'People' },
  { id: 8, url: '/images/chowmein.png', category: 'Culinary' },
  { id: 9, url: '/images/about/restaurant_story.png', category: 'Atmosphere' },
  { id: 10, url: '/images/pizza.png', category: 'Culinary' },
];

const categories = ['All', 'Culinary', 'Atmosphere', 'People'];
...
export default function Gallery() {
  ...
  return (
    <section id="gallery" className="py-24 md:py-32 bg-matteBlack border-t border-white/5">
